...
/**
 * Modello per la tabella kv nello schema mirror dinamico.
 */
class MirrorRecordKv extends Model
{
    ...
    {
        $this->setTable($schema.'.kv');

        return $this;
    }

    /**
     * Get the record that owns this KV entry.
     ...
     *
     * @return BelongsTo<MirrorRecord, MirrorRecordKv>
     */
